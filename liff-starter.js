...
function initializeApp() {
    ...
    console.log("dua : " + liff.isLoggedIn());
...
function registerButtonHandlers() {
    ...
    document.getElementById('sendMessageButton').addEventListener('click', function() {
        if (!liff.isInClient()) {
            ...
            liff.sendMessages([{
                'type': 'text',
                'text': "Hai Customer, /n terimakasi telah memesan makanan"
            }]).then(function() {
